...
4. **AI automation** — copilots that author and repair models, and machine
   learning that reviews them at scale. The answer to the skills shortage: the
   platform does the skilled repetition so scarce engineers supervise.
...
11. **Unstructured data is in scope** for the analytics workstream: documents,
